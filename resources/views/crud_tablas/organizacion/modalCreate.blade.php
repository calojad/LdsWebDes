<form method="POST" v-on:submit.prevent="createObject" xmlns:v-on="http://www.w3.org/1999/xhtml">
    <div id="modalAddOrganizacion" class="modal fade" tabindex="-1" role="dialog">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group">
                                ...
                                <input id="inpName" type="text" class="form-control" placeholder="Name" required autofocus v-model="object.nombre">
